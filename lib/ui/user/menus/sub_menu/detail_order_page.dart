...
class DetailOrderPage extends StatefulWidget {
  static const routeName = '/detail_order_page';
  static const String title = 'Rincian Pesanan';
  static String idAddress = '';
  String idOrder = '';

  DetailOrderPage(this.idOrder, {Key? key}) : super(key: key);
...
class _DetailOrderPageState extends State<DetailOrderPage> {
  ...
  void checkout() {
    ...
    List count = [];
    int index = 0;
    for (var element in order!.product!) {
      idShoes.add(element!['id_shoes']);
      sizes.add(order!.size![index]);
      count.add(order!.count![index]);
      index++;
    }
    ...
    return WillPopScope(
      ...
      child: Scaffold(
          appBar: const CustomAppbar(
            titleActions: DetailOrderPage.title,
          ),
          ...
          bottomNavigationBar: order!.status == 1
              ? Padding(
